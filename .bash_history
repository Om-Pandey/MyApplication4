...
cd reflections
git status
git add lesson-2-reflection-prompts.txt
git status
cd version-control
cd reflections
git status
...
mv git-prompt.sh.txt git-prompt.sh
mv git-prompt.sh git-prompt.sh 
mv git-prompt.sh.txt git-prompt.sh
mv git-prompt.txt git-prompt.sh
mv Downloads/git-prompt.txt git-prompt.sh
...
git status
git commit
git config --global user.email "wizardoz355@gmail.com"
...
# Make sure that exactly one argument was given
if [ $# -ne 1 ]; then     if [ $# -gt 1 ]; then         echo "$0: Got more arguments than expected.  Expected exactly 1.";     else         echo "$0: Did not receive enough arguments.  Expected exactly 1.";     fi;      echo "Usage: bash $0 <GitHub url>";     exit; fi
f [ $# -ne 1 ]; then     if [ $# -gt 1 ]; then         echo "$0: Got more arguments than expected.  Expected exactly 1.";     else         echo "$0: Did not receive enough arguments.  Expected exactly 1.";     fi;      echo "Usage: bash $0 <GitHub url>";     exit; fi j 
cd desktop
cd ~
cd~
cd Desktop
...
cd Desktop
cd pro
 git add and-nd-firebase-1.00-starting-point
 git add  C:\Users\KIIT\Desktop\pro\and-nd-firebase-1.00-starting-point
cd`
...
cd ~
git add C:\Users\KIIT\Desktop\pro\and-nd-firebase-1.00-starting-point
git config --global user.name "Om Pandey"
git config --global user.email "wizardoz355@gmail.com"
